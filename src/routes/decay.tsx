...
const ISOTOPES: Isotope[] = [
  {
    ...
    mode: "β⁻",
    particle: "electron (β⁻)",
    daughter: { symbol: "¹⁴N", z: 7, a: 14 },
    use: "Radiocarbon dating of once-living material.",
  },
  {
    id: "u238",
    symbol: "²³⁸U",
    z: 92,
    a: 238,
    half: "4.47 billion years",
    mode: "α",
    particle: "helium nucleus (α)",
    daughter: { symbol: "²³⁴Th", z: 90, a: 234 },
    use: "Dating rocks; the start of a long decay chain.",
  },
  {
    id: "i131",
    symbol: "¹³¹I",
    ...
    mode: "β⁻",
    particle: "electron (β⁻)",
    daughter: { symbol: "¹³¹Xe", z: 54, a: 131 },
    use: "Diagnosing and treating thyroid conditions.",
  },
  {
    id: "co60",
    symbol: "⁶⁰Co",
    ...
    mode: "β⁻",
    particle: "electron (β⁻)",
    daughter: { symbol: "⁶⁰Ni", z: 28, a: 60 },
    use: "Cancer radiotherapy and sterilising equipment.",
  },
  {
    id: "rn222",
    symbol: "²²²Rn",
    ...
    mode: "α",
    particle: "helium nucleus (α)",
    daughter: { symbol: "²¹⁸Po", z: 84, a: 218 },
    use: "A natural radioactive gas — a home-safety concern.",
  },
  {
    id: "h3",
    symbol: "³H",
    ...
    mode: "β⁻",
    particle: "electron (β⁻)",
    daughter: { symbol: "³He", z: 2, a: 3 },
    use: "Self-powered glow signs and research tracers.",
  },
];
...
function DecayViewer() {
  ...
  useEffect(() => {
    if (uid) void logPractice(uid, "decay");
  }, [uid]);
    ...
    <StudentShell title="Radioactive Decay">
      ...
      <div className="grid md:grid-cols-[1.1fr_1fr] gap-6 items-start">
        ...
        >
            ...
            {Array.from({ length: N_DOTS }, (_, i) => {
              ...
              return (
                <span
                  ...
                  style={{
                    background: dead ? DAUGHTER : PARENT,
                    opacity: dead ? 0.7 : 1,
                    boxShadow: dead ? "none" : `0 0 6px -1px ${PARENT}`,
                  }}
                />
              );
            })}
          ...
          <div className="flex items-center justify-between text-xs">
            <span className="inline-flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full" style={{ background: PARENT }} />{" "}
              {remaining}% {iso.symbol}
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-full" style={{ background: DAUGHTER }} />{" "}
              {100 - remaining}% {iso.daughter.symbol}
            </span>
          </div>
        </div>
        ...
        <div>
          {/* Decay equation */}
          <div
            className="rounded-2xl p-4 mb-4 flex items-center justify-center gap-3 flex-wrap"
            style={{
        ...
        <div className="mt-3 flex gap-3">
          ...
          >
            {playing ? (
              ...
              <>
                <Play className="h-4 w-4" /> Play decay
              </>
            )}
          </button>
      ...
      <p className="mt-6 text-sm text-parchment/60 max-w-2xl leading-relaxed">
        After each half-life, half of whatever remains has decayed — {iso.symbol} →{" "}
        {iso.daughter.symbol}. You can't predict which nucleus goes next, but with this many, the
        fraction is remarkably steady.
      </p>
    </StudentShell>
  );
}

function NucleusChip({
  label,
  z,
  a,
  color,
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="text-[9px] text-parchment/50 mt-1">
        Z {z} · A {a}
      </span>
    </div>
  );
