  ...
  return (
    <StudentShell title="Molecule Shapes">
      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        {/* 3D stage */}
        <div
          className="atom-stage-panel relative rounded-2xl overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 text-[9px] uppercase tracking-[0.2em] text-white/45">
            drag to spin ⟳
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-parchment/60 mb-5">
            {mol.formula} · central atom {mol.central}
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            ...
            <Fact
              label="Lone pairs"
              value={String(mol.lonePairs.length)}
          ...
          <div
            className="rounded-xl px-4 py-3 text-sm text-parchment leading-relaxed"
            style={{
...
function Fact({
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-1.5 text-[9px] tracking-[0.2em] uppercase mb-1"
        style={{ color: accent }}
      >
        {icon}
        {label}
